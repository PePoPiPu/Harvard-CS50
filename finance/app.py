...
def sell():
    ...
    if request.method == "POST":
        ...
        if transaction_checker == 1:
            ...
            db.execute("INSERT INTO transactions (sold, user_id, symbol, bought, time_of_sale, sale_value, number_sold) VALUES(?, ?, ?, ?, ?, ?, ?)", value, check_id, current_symbol, value2, sale_time, price, shares)
